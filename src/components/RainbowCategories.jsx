    ...
    return items.map((item, index) => {
      ...
      if (!selectedDomain) {
        ...
        return (
          ...
          >
            <span 
              className="block text-[9px] md:text-[10px] font-bold text-[#5B21B6] bg-white border border-slate-200 px-2 py-1 md:px-2.5 md:py-1.5 rounded-full whitespace-nowrap shadow-lg group-hover:border-[#5B21B6] group-hover:bg-purple-50 transition-colors"
